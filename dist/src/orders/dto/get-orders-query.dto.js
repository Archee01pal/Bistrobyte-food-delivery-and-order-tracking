...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: orders_service_1.OrderStatus, description: 'Filter by order status' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(orders_service_1.OrderStatus),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: ['asc', 'desc'], default: 'desc', description: 'Sort direction by date' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], GetOrdersQueryDto.prototype, "sort", void 0);
